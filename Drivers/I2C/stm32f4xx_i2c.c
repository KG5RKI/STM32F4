...
void I2C1_Master_Init(_Bool NOSTRETCH, _Bool ENGC, uint8_t FREQ)
{
...
void I2C2_Master_Init(_Bool NOSTRETCH, _Bool ENGC, uint8_t FREQ)
{
...
void I2C3_Master_Init(_Bool NOSTRETCH, _Bool ENGC, uint8_t FREQ)
{
	/* Enable I2C2 GPIO pins */
	I2C3_GPIO_Init();
...
void I2Cx_Master_Init(I2Cx n, _Bool NOSTRETCH, _Bool ENGC, uint8_t FREQ)
{
	switch (n) {
		case I2C_1: I2C1_Master_Init(NOSTRETCH, ENGC, FREQ);
		case I2C_2: I2C2_Master_Init(NOSTRETCH, ENGC, FREQ);
		case I2C_3: I2C3_Master_Init(NOSTRETCH, ENGC, FREQ);
	}
}
...
uint8_t I2C1_Master_Receive2byte()
{
}

uint8_t I2C1_Master_Receivenbyte()
{
}
